...
export async function up(knex: Knex): Promise<void> {
  return knex.schema
    .createTable('country', function (table) {
      ...
      table.string('iso3').nullable().defaultTo(null);
      table.integer('num_code').nullable().defaultTo(null);
      table.integer('phone_code').nullable().defaultTo(null);
    })
    .then(() => {
      return knex.schema.raw(`
      INSERT INTO country (id, iso, denomination, iso3, num_code, phone_code) VALUES
        ...
        (50, 'CD', 'Congo, the Democratic Republic of the', 'COD', 180, 243),
        ...
        (218, 'TR', 'The Republic of Türkiye', 'TUR', 792, 90),
